      ...
      <div className="card p-8">
        ...
        <div className="mt-4 space-y-2">
          <a
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border bg-[var(--color-surface-2)] px-4 py-2.5 text-sm hover:border-[var(--color-primary)]/60"
          >
