...
export default async function SettingsPage() {
  ...
  const cards: { href: string; title: string; description: string; icon: React.ComponentType<{ className?: string }> }[] = [
    ...
    { href: '/app/settings/proposal-templates', title: 'Proposal templates', description: 'House style for proposals — cover, intro, inclusions, tone, AI hints', icon: ScrollText },
