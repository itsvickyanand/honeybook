/**
 * Workload — per-member workload + team + project rollup.
 * (Renamed from /app/team to avoid confusion with the People + Teams settings pages.)
 */
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6 md:p-10">
      <div>
        ...
        <p className="text-sm text-[var(--color-muted)]">Per-person task load, team rollups, and active-project progress.</p>
      </div>

      <Card>
        <CardHeader title="By person" description="Open tasks per person (red = overdue)." />
